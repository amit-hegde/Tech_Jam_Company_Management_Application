<?php
// setcookie("product","MSI", time() + (86400 * 2), "/");
...
<?php
$sql="CREATE OR REPLACE VIEW `ord` AS SELECT * FROM `product` WHERE `pname` like '".$_COOKIE['product']."%';";
// echo $sql;
$conn->query($sql);
            ...
            <div class="row">
                <div class="col-md-12" style="margin-top: 2%;">
                    <div class="row grid" style="margin-left: 2%;">
                        <?php
                        $res = $conn->query("select * from ord");
                        if ($res->num_rows > 0) {
                            while ($r = $res->fetch_assoc()) {
                        ?>
                        ...
                        <center>
                            ...
                            <a href="products" class="btn btn-outline-danger">View More</a>
