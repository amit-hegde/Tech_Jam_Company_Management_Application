        ...
        <div class="table" style="margin:1px auto 10px auto;">
            <div class="tablerows" style="margin:1px auto 30px auto;">
                <table>
                    ...
                    $res = $conn->query("SELECT * FROM `order` WHERE STATUS=0");
                    if ($res->num_rows > 0) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="changestatus" method="POST">
                                        <input type="hidden" name="phno" value=<?php echo $r['phno'] ?>>
                                        <!-- <input type="hidden" name="table" value="order"> -->
                                        <button type="submit" name="id" value=<?php echo $r['pid'] ?>><i class="fas fa-clipboard-check" style="color: green;"></i></i></button>
                                        <!-- value="<%=post._id%> " -->
                                    </form>
                                </td>
                            </tr>
        ...
        <div class="table" style="margin:1px auto 10px auto ;">
            <div class="tablerows" style="margin:1px auto 10px auto ;">
                <table>
                    ...
                    $res1 = $conn->query("SELECT * FROM `order` WHERE STATUS=1");
                    if ($res1->num_rows > 0) {
